...
@SpringBootTest(classes = LovotechBonjourApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class LovotechBonjourApplicationTests {
